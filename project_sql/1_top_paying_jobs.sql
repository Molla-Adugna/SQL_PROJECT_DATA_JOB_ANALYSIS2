...
Focuses on job postings iwth specified salaries (remove nulls).
-why? Highlight the top-paying opportunities for Data Analysts, offering insight into employee
*/
SELECT 
    job_id,
    job_title,
